...
async function syncUpdatesConfigurationAsync({ projectDir, exp, workflow, env, }) {
    ...
    const expoUpdatesPackageVersion = await (0, projectUtils_1.getExpoUpdatesPackageVersionIfInstalledAsync)(projectDir);
    ...
    const updatedAndroidManifest = await config_plugins_1.AndroidConfig.Updates.setUpdatesConfigAsync(projectDir, exp, androidManifest, expoUpdatesPackageVersion);
