...
function getParameterPath(node, context) {
    ...
    (0, assert_1.default)(isValid(object, ['MemberExpression', 'Identifier', 'ThisExpression']), 'Invalid object type');
    (0, assert_1.default)(property, 'Member expression property is missing');
    let objectPath = '';
